...
gen-asm-tables:
	...
	docker run --rm -v $$(pwd):/src zer-lang-dev bash -c '\
	    ...
	    cp /tmp/src/safety/asm_register_tables_x86_64.c /src/src/safety/'
	@echo ""
