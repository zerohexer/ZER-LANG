...
2. **C-style casts ARE supported** for type conversion. `@saturate` and `@bitcast` remain for the rare cases.
   ...
   (*Motor)ctx                    // OK — pointer cast (provenance checked)
