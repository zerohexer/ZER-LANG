 ...
 *
 * WHY THIS GRID EXISTS (BUG-1002, 2026-09-02)
 * ------------------------------------------
 ...
 *
 * VERIFIED TO FIRE: against a pre-BUG-1002 build this grid fails on the
...
typedef enum {
    ...
    LF_SWITCH_ARM_BARE,    /* 0 => expr,      <-- BUG-1002 lived here   */
