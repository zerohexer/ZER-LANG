...
matrix (`tools/sink_matrix.sh`, a `make check` gate) is CLEAN — 32 ok / 0 holes.** **~3
remaining** = §C #13 (VRP JOIN silent OOB; §C #14/#15/#16 DONE), §E #27/#29 (shared-lock
ir_lower.c; §E #26/#28/#30/#31 DONE). **§A (memory safety #1–#7) FULLY DONE.** Order by risk (see
