...
struct Type {
    ...
    union {
        ...
        struct {
            ...
            /* BUG-973: this shared struct is used with a condvar intrinsic, so its
...
struct Symbol {
    ...
    int th_borrow_count;
    /* BUG-957 (2026-09-04): the LOCAL whose storage this pointer / slice /
    ...
    /* BUG-968: the MISSING third state of @container provenance.
     *
