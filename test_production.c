...
#else
    int gcc_ret = system("gcc -std=c99 -O0 -w -o _zer_prod_test _zer_prod_test.c 2>_zer_prod_err.txt");
#endif
    if (gcc_ret != 0) {
...
#else
    int run_ret = system("./_zer_prod_test");
#endif
