...
typedef struct {
    ...
    /* BUG-973: the condvar_type_ids registry is GONE. Which shared structs need a
    ...
    /* BUG-994/995 (2026-09-05): the emitter no longer synthesises early exits
    ...
    /* BUG-942: > 0 while emitting a GLOBAL variable's initializer. C requires a
