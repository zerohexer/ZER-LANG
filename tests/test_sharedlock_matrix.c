 ...
 *
 * WHY THIS GRID EXISTS (BUG-965, 2026-09-02)
 * ------------------------------------------
 ...
 *
 * VERIFIED TO FIRE: against a pre-BUG-965 build this grid fails on the
...
typedef enum {
    ...
    LF_SWITCH_ARM_BARE,    /* 0 => expr,      <-- BUG-965 lived here   */
