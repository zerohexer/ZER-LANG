...
/* BUG-1010: one entry of the read-modify-write value taint — "this LOCAL's value
...
typedef struct {
    ...
    int branch_depth;
    /* BUG-992 — loop-induction CERTAINTY. A VRP range says which values a
    ...
    /* BUG-1010: cross-statement read-modify-write taint for the ISR / spawn
     * sharing rule.
     *
