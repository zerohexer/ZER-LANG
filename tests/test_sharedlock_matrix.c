 ...
 *
 * WHY THIS GRID EXISTS (BUG-981, 2026-09-02)
 * ------------------------------------------
 ...
 *
 * VERIFIED TO FIRE: against a pre-BUG-981 build this grid fails on the
...
typedef enum {
    ...
    LF_SWITCH_ARM_BARE,    /* 0 => expr,      <-- BUG-981 lived here   */
