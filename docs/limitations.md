...
shared-scalar representation, D1 cinclude capability, scoped-borrow exclusivity)
are the deadlock-sensitive / type-system-extension / subsystem-scale pieces; each
is annotated `[OPEN]` below.
