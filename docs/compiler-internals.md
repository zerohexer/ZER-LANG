...
- **Phase 8d: `emit_ir_value` DELETED, `can_lower_expr` DELETED (2026-04-16):**
  ...
  - **6 `emit_expr` calls in `emit_rewritten_node`** (function body bridge, NOT in emit_ir_inst): (1) builtin calls — pool/slab/ring/arena inline C, (2) opaque/builtin field access, (3) NODE_INDEX — bounds checks, (4) NODE_ASSIGN — field writes/compound/volatile, (5) optional binary compare, (6) complex intrinsics (@barrier/@atomic/@cond/@sem). Each is 10-200 lines of emit_expr logic to replace.
