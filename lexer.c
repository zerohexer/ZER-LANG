...
static TokenType check_keyword(const char *word, size_t word_len) {
    ...
    case 'A':
        ...
        break;
    case 'B':
        if (word_len == 7 && memcmp(word+1, "arrier", 6) == 0) return TOK_BARRIER;
        break;
    case 'H':
    ...
    case 'c':
        ...
        if (word_len == 8 && memcmp(word+1, "omptime", 7) == 0) return TOK_COMPTIME;
    ...
    case 's':
        ...
        if (word_len == 13 && memcmp(word+1, "tatic_assert", 12) == 0) return TOK_STATIC_ASSERT;
...
const char *token_type_name(TokenType type) {
    ...
    case TOK_BARRIER: return "Barrier";
